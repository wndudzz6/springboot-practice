...
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.jsonPath; //jsonPath오류
...
class BlogApiControllerTest {
    ...
    //when : 블로그 글 추가 API에 요청 보냄, 요청타입 JSON, given절에서 미리 만들어둔 객체를 요청 본문으로 보냄
    //then : 응답코드가 201 Created인지 확인, Blog를 전체 조회해 크기가 1인지 확인, 실제로 저장된 데이터와 요청값 비교
